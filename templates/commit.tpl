 ...
 *}
 ...
 <div class="page_nav">
   {* Nav *}
   {include file='project_header.tpl' unselect='commit' commit=$commit}
   <br /><br />
 </div>
 ...
 <div class="title_text">
   ...
   <table cellspacing="0">
     ...
     <tr>
       ...
       <td class = "link"><a href="{$SCRIPT_NAME}?p={$project->GetProject()|urlencode}&a=commitdiff&h={$commit->GetHash()}&hp={$mark}">Diff against selected (<abbr title="{$mark}">{$mark_abbr}</abbr>)</a></td>
       {/if}
     <tr>
   </table>
 </div>
